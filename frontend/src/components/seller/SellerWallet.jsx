  ...
  if (error) {
    return (
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">My Shop Wallet & Settlements</h2>
          <p className="text-sm text-gray-500">Track your product dispatch earnings, pending escrow reserves, and withdrawal payouts.</p>
        </div>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <GlassCard className="p-5 border-black/[0.04]">
          ...
          <p className="text-xs font-bold text-muted uppercase tracking-wider mt-1">Total Withdrawn</p>
        </GlassCard>
      </div>
